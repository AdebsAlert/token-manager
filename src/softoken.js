...
*/
softoken.prototype.create = function (opts) {
  var _this = this
...
* @method get
*/
softoken.prototype.get = function (token) {
  var _this = this
  var tokenKey = _this.namespaceKey + PREFIX.TOKEN + token

  return Promise.all([
    softoken.jwtVerify(token, _this.jwtSecret),
...
* @method getByUserId
*/
softoken.prototype.getByUserId = function (userId) {
  var _this = this
...
* @method extend
*/
softoken.prototype.extend = function (token, ttl) {
...
* @method destroy
*/
softoken.prototype.destroy = function (token) {
  var _this = this
  var tokenKey = _this.namespaceKey + PREFIX.TOKEN + token
...
* @method destroyUser
*/
softoken.prototype.destroyUser = function (uid) {
  var _this = this
...
* @method cleanup
*/
softoken.prototype.cleanup = function (cleanupAll) {
  var _this = this
  var tokenListKey = _this.namespaceKey + PREFIX.TOKEN + 'list'
  var to = Date.now()
